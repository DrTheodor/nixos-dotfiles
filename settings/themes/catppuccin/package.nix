let
  validThemes = [ "bat" "bottom" "btop" "grub" "hyprland" "k9s" "kvantum" "lazygit" "plymouth" "qt5ct" "refind" "rofi" "starship" "thunderbird" "waybar" "sddm" ];
in
{ fetchFromGitHub
, lib
, stdenvNoCC
...
stdenvNoCC.mkDerivation {
  ...
  '' + lib.optionalString (lib.elem "sddm" themeList) ''
    mkdir -p $out/share/sddm/themes
    cp -r ${sources.sddm}/src/catppuccin-${variant} $out/share/sddm/themes/catppuccin-${variant}
